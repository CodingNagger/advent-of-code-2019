...
namespace AdventOfCode2019.Tests
{
    public class Day14Tests : AbstractTwoPartDayTests
    {
        ...
        [InlineData("10", new string[] { "10 ORE => 10 A", "5 A => 10 B", "5 A, 5 B => 1 FUEL" })]
        ...
        public void TestReactionCanReverseReact() {
            ...
            var reaction = new Reaction(new ChemicalsStore(), reactionInput, reactionOutput);
        ...
        public void TestReactionReverseReact() {
            ...
            Assert.Equal(new Chemical { Name = "ORE", Quantity = 9 }, new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "A", Quantity = 2 })[0]);
            Assert.Equal(new Chemical { Name = "ORE", Quantity = 18 }, new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "A", Quantity = 3 })[0]);
            Assert.Equal(new Chemical { Name = "ORE", Quantity = 45 }, new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "A", Quantity = 10 })[0]);
            Assert.Equal(new Chemical[0], new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "B", Quantity = 2 }));
            Assert.Equal(new Chemical[0], new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "ORE", Quantity = 1000 }));
        }
        ...
        public void TestReactionReverseReactRoundsUp() {
            ...
            Assert.Equal(new Chemical { Name = "ORE", Quantity = 30 }, new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "A", Quantity = 28 })[0]);
            Assert.Equal(new Chemical { Name = "ORE", Quantity = 30 }, new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "A", Quantity = 30 })[0]);
            Assert.Equal(new Chemical { Name = "ORE", Quantity = 40 }, new Reaction(new ChemicalsStore(), reactionInput, reactionOutput).ReverseReact(new Chemical { Name = "A", Quantity = 38 })[0]);
        }
        ...
        public void TestParseSimpleReaction() {
            ...
            var expectedResult = new Reaction(surplus, new [] { new Chemical { Name = "ORE", Quantity = 10 } }, new Chemical { Name = "A", Quantity = 10 });
            Assert.Equal(expectedResult, Reaction.Parse(surplus, data));
        }
